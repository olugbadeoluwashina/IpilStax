...
export type KyselyNewProject = Insertable<ProjectsTable>;
export type KyselyAProject = Selectable<ProjectsTable>;
export type KyselyUpdateProject = Updateable<ProjectsTable>;
